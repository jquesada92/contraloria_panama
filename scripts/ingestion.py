# Los archivos Parquet se escriben en la carpeta de staging definida por STAGING_DIR:
# STAGING_DIR = Path(SOURCE_PATH) / "staging"
# Por defecto, esto es './staging/' en el directorio actual.

# Ejemplo de escritura en el método get
"""
...
import warnings
warnings.filterwarnings("ignore")  # Suppresses warnings as in original code
...
options.mode.chained_assignment = None  # Keeps pandas chained assignment warnings off
...
STAGING_DIR = Path(SOURCE_PATH) / "landing"
...
def validate_last_update_date(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        try:
            ...
            print(last_text)  # debug print as in original code
            ...
            if last_date < webpage_date:
                ...
                ValueError('no updates available')
...
def execute_ingestion():
    ...
    if errors:
        ...
        if errors:
            raise ValueError("Still failing after retry:", errors)
